...
if __name__=='__main__':
    input_dir = '/Volumes/Digital pathology image lib-1/SenNet JHU TDA Project/SN-LW-PA-P003-B1_SNP004/HESS/AlignIM/run5/Dalign__imdsf2__dsfout1_padsz500'
    ...
    ims2ometiff(ims,os.path.join(output_dir,'zstack_t2.jpeg.ome.tiff'))
